...
<div class="container">
  ...
  <div class="container">
  <h2>Attendance Status-Batch C2(DATA STRUCTURES)</h2>
      ...
      <tr>
       <?php
        ...
        echo "<td>";
            ...
            $sql="SELECT 'std1' as name ,count(*)*100/(select count(*) from `c2ds`) as percentage FROM `c2ds` WHERE std1=1";
            $res=mysql_query($sql,$md) or die("nq");
      ...
      <tr>
       <?php
        ...
        echo "<td>";
            ...
            $sql="SELECT 'std2' as name ,count(*)*100/(select count(*) from `c2ds`) as percentage FROM `c2ds` WHERE std2=1";
            $res=mysql_query($sql,$md) or die("nq");
      ...
      <tr>
       ...
       $sql="SELECT * FROM  `c2` WHERE std='std3' ";
        ...
        echo "<td>";
            ...
            $sql="SELECT 'std3' as name ,count(*)*100/(select count(*) from `c2ds`) as percentage FROM `c2ds` WHERE std3=1";
            $res=mysql_query($sql,$md) or die("nq");
      ...
      <tr>
       <?php
        ...
        echo "<td>";
            ...
            $sql="SELECT 'std4' as name ,count(*)*100/(select count(*) from `c2ds`) as percentage FROM `c2ds` WHERE std4=1";
            $res=mysql_query($sql,$md) or die("nq");
