...
<div class="container">
  <div class="jumbotron">
	...
	<form class="form-inline" action="c1ds1php.php"  method="post" role="form">
...
<br />
<div class="container">
  <h2>Batch-C1(DATA STRUCTURES)</h2>
	...
	<tr>
 	...
 	<td> <form> <input type="radio" name="attendence4" value="0" required=""></td> 
	  ...
	  <tr>
		...
		echo"</td>";
		?>
        <td> <form> <input type="radio" name="attendence5" value="1" required="" value="checked"></td>
 	<td> <form> <input type="radio" name="attendence5" value="0" required=""></td> 
      </tr>
	  ...
	  <tr>
		...
		echo"</td>";
		?>
        <td> <form> <input type="radio" name="attendence6" value="1" required="" value="checked"></td>
 	<td> <form> <input type="radio" name="attendence6" value="0" required=""></td> 
      </tr>
...
<br />
<form action="c1ds1php.php"  method="post">
