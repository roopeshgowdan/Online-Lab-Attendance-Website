...
<div class="container">
  <div class="jumbotron">
	...
	<form class="form-inline" action="c4wp1php.php"  method="post" role="form">
...
<br />
<div class="container">
  <h2>Batch-C4(Web Programming)</h2>
      ...
      <tr>
	   <?php
		...
		<form> <input type="radio" name="attendence"  value="1" required=""></td>
 	    <td><form> <input type="radio" name="attendence"  value="0" required=""></td>   
 </tr>
      <tr>
        <?php
...
<br />
<form action="c4wp1php.php"  method="post">
